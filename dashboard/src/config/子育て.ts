...
export const childrenDiseaseMedicalExpensesData: HelpDeskData = {
  埼玉県: {
    // TODO: 埼玉県の他の市町村に対しても窓口設定
    // （一覧は https://www.pref.saitama.lg.jp/a0704/boshi/newsyouman.html に記載 ）
    富士見市: {
      施設名: '朝霞保健所',
      所在地: '朝霞市青葉台1-10-5',
      電話番号: '	048-461-0468',
...
export const childSupportData: HelpDeskData = {
  埼玉県: {
    富士見市: {
      施設名: '富士見市子ども未来応援センター',
      所在地: '埼玉県富士見市大字鶴馬3351-2 (健康増進センター内)',
...
export const saitamaPrivateSchoolData: HelpDeskData = {
