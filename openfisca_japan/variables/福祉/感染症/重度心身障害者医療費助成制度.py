...
class 重度心身障害者医療費助成制度の対象者である可能性がある(Variable):
    value_type = bool
    entity = 人物
    definition_period = DAY
    label = "重度心身障害者医療費助成制度の対象である可能性があるか否か"
    reference = "https://pap-net.jp/medical_bills/subsidy/"
    documentation = """
    都道府県によって条件や助成額が異なるため、対象か否かのみ計算
    いずれかの都道府県の条件に該当する場合はTrueとする
    ...
    def formula(対象人物, 対象期間, _parameters):
        ...
        # (上記の障害条件に含まれない条件を追加)
        # https://www.saitama-koukikourei.org/wp/wp-content/uploads/3f3075c8c3430d24cd53e79eba2e4bc7.pdf
